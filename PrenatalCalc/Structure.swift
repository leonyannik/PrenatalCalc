...
class ProvidedSolutionValues: Codable {
    ...
    var naclhip_:Double = 4
    var lípidos:Double = 3
...
var solutionValuesKeys = ["líquidos_iv_tot", "sol_fisiológica", "trophamine_10", "trophamine_8", "intralipid_20", "sg_50", "sg_10", "kcl_amp_10", "kcl_amp_5", "naclhip", "fosfato_k", "mvi", "oligoelementos", "l_cisteína", "carnitina", "heparina", "abd", "glucca", "magnesio", "gluccaMl", "magnesioMl"]
